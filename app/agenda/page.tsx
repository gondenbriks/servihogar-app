    ...
    return (
        <div className="bg-[#0a0c10] min-h-screen text-white font-sans max-w-5xl mx-auto relative overflow-x-hidden border-x border-white/5 pb-24">
                ...
                <div className="flex gap-2 overflow-x-auto no-scrollbar py-4 mt-2">
                    {[
                        ...
                        <motion.button
                            ...
                            className={`px-5 py-3 rounded-2xl text-[9px] font-black uppercase tracking-[0.2em] transition-all border shrink-0 flex items-center gap-3 ${filter === f.id
                                ? 'bg-white text-black border-white shadow-lg'
                                : 'bg-gray-900/60 border-white/5 text-gray-500'
                                }`}
                        >
                            {f.label}
            ...
            <main className="p-6 space-y-6">
                <div className="bg-gray-900/20 border border-white/5 rounded-[2.5rem] p-4 flex items-center justify-between shadow-inner">
                    <div className="flex items-center gap-4">
                        ...
                        <select
                            ...
                            className="bg-transparent text-[10px] font-black uppercase tracking-widest text-[#135bec] outline-none cursor-pointer appearance-none pr-6"
                        >
                ...
                {isLoading ? (
                    ...
                    <motion.div
                        ...
                        className="flex flex-col items-center justify-center py-32 text-gray-700 bg-gray-900/10 border-2 border-dashed border-white/5 rounded-[4rem] text-center px-10"
                    >
                        <CalendarDays size={64} className="mb-6 opacity-20" />
                        <h3 className="font-black text-lg text-gray-500 tracking-tight mb-2">Sin actividad</h3>
                    </motion.div>
                ) : (
            ...
            {/* Float Action Button instead of bottom bar */}
            <motion.button
